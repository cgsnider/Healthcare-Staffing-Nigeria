        ...
        if (userType === 'Admin') {
            return (
                <>
                    ...
                    <button className='menu_item' type='button' role='menuitem' onClick={()=>navigate('/manage_professionals')}>View Professionals</button>
                    <button className='menu_item' type='button' role='menuitem' onClick={()=>navigate('/manage_facilities')}>View Facilities</button>
                </>
            )
        }
