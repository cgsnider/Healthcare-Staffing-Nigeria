        ...
        if (userType === 'Facility') {
            return (
                <>
                    ...
                    <button className='menu_item' type='button' role='menuitem' onClick={()=>navigate('/manage_postings')}>My Postings</button> {/** link to view facilities current active postings */}
