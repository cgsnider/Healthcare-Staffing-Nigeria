                ...
                <div class="md:flex no-wrap md:-mx-2 ">
                    <div class="w-full md:w-3/12 md:mx-2">
                        <div class="bg-white p-3 border-t-4 border-green-400">
                            ...
                            <h1 class="text-gray-900 font-bold text-xl leading-8 my-1">{profileInfo.name}</h1>
                            <h3 class="text-gray-600 font-lg text-semibold leading-6">{profileInfo.specialization}</h3>
                            ...
                            <ul
                                ...
                                <li class="flex items-center py-3">
                                    ...
                                    <span class="ml-auto">
                                        ...
                                        <span class="bg-green-500 py-1 px-2 rounded text-white text-sm">Verified</span>
                                        :
                                        <div className="ml-auto mr-0">
                                            <span class="bg-red-500 py-1 px-2 rounded text-white text-sm">Unverified</span>
                                        </div>
                                        }
                                    </span>
                                </li>
                                <li class="flex items-center py-3">
                                    ...
                                    <span class="ml-auto">Resume</span>
                                    :
                            ...
                            <div class="text-gray-700">
                                <div class="grid md:grid-cols-2 text-sm">
                                    <div class="grid grid-cols-2">
                                        ...
                                        <div class="px-4 py-2">{profileInfo.name.split(' ')[0]}</div>
                                    </div>
                                    <div class="grid grid-cols-2">
                                        <div class="px-4 py-2 font-semibold">Last Name</div>
                                        <div class="px-4 py-2">{profileInfo.name.split(' ')[1]}</div>
                                    </div>
                                    <div class="grid grid-cols-2">
                                        <div class="px-4 py-2 font-semibold">Gender</div>
                                        <div class="px-4 py-2">{profileInfo.gender}</div>
                                    </div>
                                    <div class="grid grid-cols-2">
                                        <div class="px-4 py-2 font-semibold">Contact No.</div>
                                        <div class="px-4 py-2">{profileInfo.phoneNumber /**not sure how to handle country code formatting */}</div>
                                    </div>
                                    <div class="grid grid-cols-2">
                                        <div class="px-4 py-2 font-semibold">Current Address</div>
                                        <div class="px-4 py-2">{(profileInfo.address || "None")}</div>
                                    </div>
                                    <div class="grid grid-cols-2">
                                        <div class="px-4 py-2 font-semibold">Email.</div>
                                        <div class="px-4 py-2">
                                            <a class="text-blue-800" href={`mailto:${profileInfo.email}`}>{profileInfo.email}</a>
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-2">
                                        <div class="px-4 py-2 font-semibold">Birthday</div>
                                        <div class="px-4 py-2">{profileInfo.DoB}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-2">
                                <div>
                                    ...
                                    <ul class="list-inside space-y-2">
                                        <li>
                                            <div class="text-gray-900">None</div>
                                        </li>
                                    </ul>
                                </div>
                                <div>
